...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  // 강습(lesson_open=false)도 닫혀 있는 상태라 "다른 프로그램을 선택하라"고 하면
  // 갈 곳이 없는 안내가 된다. 현장접수 경로를 분명히 알려준다.
  special_full:
    '서핑 특화 체험은 온라인 접수가 마감되었습니다. 9월 19일(토)~20일(일) 행사 현장에서 접수하실 수 있으니 웨이브웍스 양양(현남면 인구중앙길 110)으로 방문해 주세요. 문의 010-9542-3775',
  all_programs_closed:
