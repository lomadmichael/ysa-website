...
const inputCls =
  'block w-full rounded-lg border border-gray-300 bg-white px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-purple/40 focus:border-purple';
  ...
  return (
    <div className="mx-auto max-w-md">
      <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        <h2 className="mt-2 text-xl font-bold text-navy">신청 조회 · 수정 · 취소</h2>
        <p className="mt-2 text-sm leading-relaxed text-navy/60">
          {EVENT.name} 접수에 사용하신 휴대폰 번호로 본인 인증 후 신청 내용을 확인하고
          수정하거나 취소할 수 있습니다.
        </p>
        ...
        {!reqState.sent ? (
          ...
          <form action={requestAction} className="mt-6 space-y-3">
            ...
            <button
              type="submit"
              disabled={requesting}
              className="w-full rounded-lg bg-purple px-5 py-3 text-sm font-bold text-white transition hover:bg-purple/90 disabled:opacity-50"
            >
