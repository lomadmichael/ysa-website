...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  // 마이그레이션 018 — 샵별 명단 전달(9/17) 후 본인 취소를 닫았다(surfcamp.config.self_cancel_open).
  cancel_closed: `참가자 명단이 서핑샵에 전달되어 온라인 취소는 마감되었습니다. 참가가 어려우시면 운영본부(${INQUIRY_TEL})로 연락해 주세요.`,
