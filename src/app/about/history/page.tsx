...
const TIMELINE: { year: string; items: { date: string; text: string }[] }[] = [
  {
    year: '2025',
    items: [
      { date: '2025. 10-11.', text: '\'양양, 바다를 넘어 문화로 - 10년의 기록\' 전시회 개최' },
      { date: '2025. 10.', text: '제2회 양양군의장배 전국서핑대회 개최' },
      { date: '2025. 09-11.', text: '제10회 \'양양 서핑 페스티벌\' 개최' },
      { date: '2025. 05-11.', text: '서핑 전문인력(심판, 강사) 양성 교육' },
      { date: '2025. 05-11.', text: '레저스포츠 체험(요가, 랜드서핑) 교실 운영' },
      { date: '2025. 05-11.', text: '오션프렌들리 양양 캠페인 운영' },
    ],
  },
  {
    year: '2024',
    items: [
      { date: '2024. 10.', text: '제1회 양양군의장배 전국서핑대회 개최' },
      { date: '2024. 09-11.', text: '제9회 \'양양 서핑 페스티벌\' 개최' },
      { date: '2024. 05-11.', text: '서핑 전문인력(심판, 강사) 양성 교육' },
    ],
  },
  {
    year: '2023',
    items: [
      { date: '2023. 09-11.', text: '제8회 \'양양 서핑 페스티벌\' 개최' },
      { date: '2023. 05-11.', text: '서핑 강사 인증 사업 「나는 양양의 서핑강사다」 진행' },
    ],
  },
  {
    year: '2022',
